...
var Interpreter = /** @class */ (function () {
    ...
    Interpreter.prototype.setMap = function (token, data, pre) {
        this.data.push(new Data(token, data, pre));
    };
    Interpreter.prototype.interprete = function (expressions) {
        var _this = this;
        var delta = 0;
    ...
    Interpreter.prototype.getDate = function (str) {
        var aux = str.split("-");
    ...
    Interpreter.prototype.eval = function (expressions) {
        var _this = this;
        var delta = 0;
        expressions.forEach(function (e) {
            _this.data.forEach(function (d) {
