export function evaluate(regex: RegExp, string: string, data: any, numeric?:boolean) {
...
export function evalExp(string: string, data: any) {
    const regex = /\{=([a-z0-9-_\.]+)\}/gi;

    return evaluate(regex, string, data);
}

export function evalJson(string: string, data: any) {
    const regex = /"\{#([a-z0-9-_\.\s]+)\}"/gi;

    return evaluate(regex, string, data, true);
}

export function evalAll(string: string, data: any) {
